...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pricecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pricecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pricecoin transaction") + "\n" +
              "  pricecoin-tx [options] -create [commands]   " + _("Create hex-encoded pricecoin transaction") + "\n" +
              "\n";
