...
const char * const BITCOIN_CONF_FILENAME = "pricecoin.conf";
const char * const BITCOIN_PID_FILENAME = "pricecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pricecoin";
#else
    // Unix
