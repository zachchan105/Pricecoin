...
const std::string strMessageMagic = "Pricecoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PRCN additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // set reward to 14257.197095525893
    if (nHeight >= 175000)
        nSubsidy = 1425719709552;
...
void ThreadScriptCheck() {
    RenameThread("pricecoin-scriptch");
