...
"""Verify that starting pricecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pricecoin with -h for help text")
        ...
        self.log.info("Start pricecoin with -version for version information")
